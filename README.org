...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-c e") 'config-visit) ; you can bin any key chord you like, here I chose "C-c e"
#+END_SRC
**** Reload Config
After you changed stuff in your config you might want to reload it. Keep in mind that some changes need a restart of Emacs so this will not always work.
 #+BEGIN_SRC emacs-lisp
    ...
    (global-set-key (kbd "C-c u") 'config-reload) ; the key chord to execute this function, here I chose "C-c u"
#+END_SRC
*** Aesthetics
**** Color Themes
