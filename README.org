...
#+END_SRC
**** Markdown Mode
If possibel nowadays I use Org but Markdown also comes in handy a lot of times and then you might want to use [[https://github.com/jrblevin/markdown-mode][Markdown Mode]].
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** Web Mode
[[http://web-mode.org/][Web Mode]] is "an autonomous emacs major-mode for editing web templates" and if you are coding anything for the web it will be quite usefull. It gives you proper semantic structure, syntax highlighting and more. I personally also prefer it for [[https://vuejs.org/][Vue.js]]. There is also a mode for Vue but that didnt really work for me.
#+BEGIN_SRC emacs-lisp
